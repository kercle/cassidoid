  ...
  return { pattern: e === "/" ? /^\/$/ : new RegExp(`^${Et(e).map((a) => {
    ...
    return "/" + o.map((l, c) => {
      if (c % 2) {
        ...
        const f = bt.exec(l), [, h, v, u, p] = f;
        return t.push({ name: u, matcher: p, optional: !!h, rest: !!v, chained: v ? c === 1 && o[0] === "" : false }), v ? "([^]*?)" : h ? "([^/]*)?" : "([^/]+?)";
      }
      return he(l);
    }).join("");
  }).join("")}/?$`), params: t };
...
let _ = { branch: [], error: null, url: null }, tt = false, oe = false, Ke = true, J = false, B = false, nt = false, Te = false, at, w, R, N;
const se = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map();
async function cn(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_1d9vl5q) == null ? void 0 : _a3.data) && globalThis.__sveltekit_1d9vl5q.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = xt(e), I = document.documentElement, ve = t, me = e.nodes[0], ne = e.nodes[1], me(), ne(), w = (_d2 = history.state) == null ? void 0 : _d2[K], R = (_e6 = history.state) == null ? void 0 : _e6[G], w || (w = R = Date.now(), history.replaceState({ ...history.state, [K]: w, [G]: R }, ""));
  const a = C[w];
  function r() {
...
async function st(e, t, n) {
  ...
  if (a && a.remove(), Object.assign(k, e.props.page), at = new y.root({ target: t, props: { ...e.props, stores: $, components: re }, hydrate: n, sync: false }), await Promise.resolve(), ot(R), n) {
    const r = { from: null, to: { params: _.params, route: { id: ((_a3 = _.route) == null ? void 0 : _a3.id) ?? null }, url: new URL(location.href), scroll: C[w] ?? q() }, willUnload: false, type: "enter", complete: Promise.resolve() };
    F.forEach((i) => i(r));
  }
  oe = true;
}
...
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = _.url ? e !== le(_.url) : false, h = _.route ? r.id !== _.route.id : false, v = Wt(_.url, n);
  let u = false;
...
function Ht() {
  ...
  async function i(s, l) {
    ...
    if (!c || f) return;
    const { url: h, external: v, download: u } = _e(c, x, y.hash);
    if (v || u) return;
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    if (!ye) {
      if ((_a4 = t.state) == null ? void 0 : _a4[K]) {
        ...
        if (o === R && (nt || s)) {
          r !== k.state && (k.state = r), e(i), C[w] = q(), a && scrollTo(a.x, a.y), w = n;
          return;
        }
        const c = n - w;
...
async function Qt(e, { status: t = 200, error: n, node_ids: a, params: r, route: i, server_route: o, data: s, form: l }) {
  ...
  try {
    ...
    h = await Pe({ status: Le(u), error: await X(u, { url: c, params: r, route: i }), url: c, route: i }), e.textContent = "", v = false;
  }
