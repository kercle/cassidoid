...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && F.delete(Re(e)), vt(e, t));
...
const x = ((_a = globalThis.__sveltekit_1fydtqv) == null ? void 0 : _a.base) ?? "/cassida", Lt = ((_b = globalThis.__sveltekit_1fydtqv) == null ? void 0 : _b.assets) ?? x ?? "", At = "1775064754938", Ge = "sveltekit:snapshot", We = "sveltekit:scroll", Ye = "sveltekit:states", Ut = "sveltekit:pageurl", K = "sveltekit:history", W = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function ze(e) {
...
let _ = { branch: [], error: null, url: null }, tt = false, oe = false, Ke = true, J = false, M = false, nt = false, Te = false, at, w, R, N;
const se = /* @__PURE__ */ new Set(), Be = /* @__PURE__ */ new Map();
async function cn(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_1fydtqv) == null ? void 0 : _a3.data) && globalThis.__sveltekit_1fydtqv.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = xt(e), I = document.documentElement, ve = t, me = e.nodes[0], ne = e.nodes[1], me(), ne(), w = (_d2 = history.state) == null ? void 0 : _d2[K], R = (_e6 = history.state) == null ? void 0 : _e6[W], w || (w = R = Date.now(), history.replaceState({ ...history.state, [K]: w, [W]: R }, ""));
  const a = C[w];
  function r() {
    a && (history.scrollRestoration = "manual", scrollTo(a.x, a.y));
  }
  n ? (r(), await Qt(ve, n)) : (await B({ type: "enter", url: ze(y.hash ? tn(new URL(location.href)) : location.href), replace_state: true }), r()), Xt();
}
function Dt() {
...
function Me() {
  Ae(w), Ne(We, C), rt(R), Ne(Ge, z);
}
async function Vt(e, t, n, a) {
  let r;
  t.invalidateAll && we(), await B({ type: "goto", url: ze(e), keepfocus: t.keepFocus, noscroll: t.noScroll, replace_state: t.replaceState, state: t.state, redirect_count: n, nav_token: a, accept: () => {
...
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = _.url ? e !== le(_.url) : false, h = _.route ? r.id !== _.route.id : false, v = Ft(_.url, n);
  let u = false;
...
async function B({ type: e, url: t, popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o = {}, redirect_count: s = 0, nav_token: l = {}, accept: c = Ve, block: f = Ve, event: h }) {
  ...
  if (Dt(), Ae(m), rt(g), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), o = n ? n.state : o, !n) {
    const b = i ? 0 : 1, Q = { [K]: w += b, [W]: R += b, [Ye]: o };
...
function Xt() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    M && (M = false, history.replaceState({ ...history.state, [K]: ++w, [W]: R }, "", location.href));
  });
