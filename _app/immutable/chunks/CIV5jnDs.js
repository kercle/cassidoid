...
import { o as Ce } from "./TMq5ylFL.js";
class ke {
  constructor(t, n) {
...
const x = ((_a = globalThis.__sveltekit_1jts7qr) == null ? void 0 : _a.base) ?? "/cassidoid", Lt = ((_b = globalThis.__sveltekit_1jts7qr) == null ? void 0 : _b.assets) ?? x ?? "", At = "1773525081429", Ge = "sveltekit:snapshot", We = "sveltekit:scroll", Ye = "sveltekit:states", Ut = "sveltekit:pageurl", K = "sveltekit:history", W = "sveltekit:navigation", C = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function ze(e) {
...
const Ct = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), j = Fe(We) ?? {}, z = Fe(Ge) ?? {}, $ = { url: De({}), page: De({}), navigating: be(null), updated: Tt() };
function Ae(e) {
  j[e] = q();
}
function Nt(e, t) {
