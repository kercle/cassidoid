...
let __tla = (async () => {
  ...
  m = function(e, t, n, s) {
    var r = I(e);
    h && (r[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === C) || r[t] !== (r[t] = n) && (t === "loading" && (e[M] = n), n == null ? e.removeAttribute(t) : typeof n != "string" && N(e).includes(t) ? e[t] = n : e.setAttribute(t, n));
  };
  function I(e) {
  ...
  const k = "" + new URL("../assets/kernel_bg.BaCRcMC8.wasm", import.meta.url).href, B = async (e = {}, t) => {
    let n;
  ...
  }, k), K = f.memory, P = f.eval_input, V = f.__wbindgen_externrefs, X = f.__wbindgen_malloc, Y = f.__wbindgen_realloc, $ = f.__wbindgen_free, p = f.__wbindgen_start, q = Object.freeze(Object.defineProperty({
    __proto__: null,
  ...
  function z() {
    ...
    async function s() {
      return n((a) => ({
        ...
        send: async (a) => {
          const o = await O(a), i = typeof o == "string" ? JSON.parse(o) : o;
