import { h as p, aR as A, aS as S, N as T, aT as x, aU as E, aV as M, aW as L, aX as U } from "./BfX1JZpI.js";
let te, Q, ee, y;
let __tla = (async () => {
  const N = /* @__PURE__ */ Symbol("is custom element"), O = /* @__PURE__ */ Symbol("is html"), W = S ? "link" : "LINK";
  ee = function(e) {
    if (p) {
      var t = false, n = () => {
        if (!t) {
  ...
  y = function(e, t, n, o) {
    var s = I(e);
    p && (s[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === W) || s[t] !== (s[t] = n) && (t === "loading" && (e[E] = n), n == null ? e.removeAttribute(t) : typeof n != "string" && k(e).includes(t) ? e[t] = n : e.setAttribute(t, n));
  };
  function I(e) {
  ...
  const B = "" + new URL("../assets/kernel_bg.BxaUOzXm.wasm", import.meta.url).href, C = async (e = {}, t) => {
    let n;
  ...
  }, B), z = f.memory, J = f.eval_input, K = f.__wbindgen_externrefs, P = f.__wbindgen_malloc, V = f.__wbindgen_realloc, Y = f.__wbindgen_free, v = f.__wbindgen_start, $ = Object.freeze(Object.defineProperty({
    __proto__: null,
