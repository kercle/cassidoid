...
let ie, se, ae, p;
let __tla = (async () => {
  const I = /* @__PURE__ */ Symbol("is custom element"), N = /* @__PURE__ */ Symbol("is html"), B = E ? "link" : "LINK";
  ae = function(e) {
    if (S) {
      var t = false, n = () => {
        if (!t) {
  ...
  p = function(e, t, n, o) {
    var r = O(e);
    S && (r[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === B) || r[t] !== (r[t] = n) && (t === "loading" && (e[R] = n), n == null ? e.removeAttribute(t) : typeof n != "string" && D(e).includes(t) ? e[t] = n : e.setAttribute(t, n));
  };
  function O(e) {
  ...
  const F = "" + new URL("../assets/kernel_bg.BZsVdR_b.wasm", import.meta.url).href, z = async (e = {}, t) => {
    let n;
  ...
  }, F), P = d.memory, Y = d.__wbg_cassidakernel_free, q = d.cassidakernel_execute, J = d.cassidakernel_new, Z = d.eval_input, $ = d.__wbindgen_externrefs, Q = d.__wbindgen_malloc, ee = d.__wbindgen_realloc, te = d.__wbindgen_free, v = d.__wbindgen_start, ne = Object.freeze(Object.defineProperty({
    __proto__: null,
