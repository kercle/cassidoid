...
const x = ((_a = globalThis.__sveltekit_tlf1zz) == null ? void 0 : _a.base) ?? "/toy-cas", Lt = ((_b = globalThis.__sveltekit_tlf1zz) == null ? void 0 : _b.assets) ?? x ?? "", At = "1771947961428", We = "sveltekit:snapshot", Fe = "sveltekit:scroll", Ge = "sveltekit:states", Ut = "sveltekit:pageurl", V = "sveltekit:history", F = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function Ye(e) {
...
function te(e) {
  ...
  for (; s && s !== document.documentElement; ) a === null && (a = z(s, "preload-code")), r === null && (r = z(s, "preload-data")), t === null && (t = z(s, "keepfocus")), n === null && (n = z(s, "noscroll")), i === null && (i = z(s, "reload")), o === null && (o = z(s, "replacestate")), s = He(s);
  function l(c) {
    switch (c) {
      case "":
      case "true":
...
let _ = { branch: [], error: null, url: null }, tt = false, oe = false, Ve = true, J = false, M = false, nt = false, Te = false, at, v, R, N;
const se = /* @__PURE__ */ new Set(), Ke = /* @__PURE__ */ new Map();
async function cn(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_tlf1zz) == null ? void 0 : _a3.data) && globalThis.__sveltekit_tlf1zz.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = xt(e), I = document.documentElement, we = t, me = e.nodes[0], ne = e.nodes[1], me(), ne(), v = (_d2 = history.state) == null ? void 0 : _d2[V], R = (_e6 = history.state) == null ? void 0 : _e6[F], v || (v = R = Date.now(), history.replaceState({ ...history.state, [V]: v, [F]: R }, ""));
  const a = C[v];
  function r() {
...
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = _.url ? e !== le(_.url) : false, h = _.route ? r.id !== _.route.id : false, w = Bt(_.url, n);
  let u = false;
...
async function Pe({ status: e, error: t, url: n, route: a }) {
  ...
  try {
    ...
    if (o instanceof Se) return zt(new URL(o.location, location.href), {}, 0);
    throw o;
  }
}
async function Gt(e) {
...
async function K({ type: e, url: t, popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o = {}, redirect_count: s = 0, nav_token: l = {}, accept: c = ze, block: f = ze, event: h }) {
  var _a3;
  const w = N;
  N = l;
  ...
  const m = v, g = R;
  c(), J = true, oe && p.navigation.type !== "enter" && $.navigating.set(G.current = p.navigation);
  let d = u && await it(u);
  if (!d) {
  ...
  if (qt(), Ae(m), rt(g), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), o = n ? n.state : o, !n) {
    const b = i ? 0 : 1, Q = { [V]: v += b, [F]: R += b, [Ge]: o };
  ...
  !a && !ft && en(t, !P), Ve = true, d.props.page && Object.assign(k, d.props.page), J = false, e === "popstate" && ot(R), p.fulfil(void 0), p.navigation.to && (p.navigation.to.scroll = D()), W.forEach((b) => b(p.navigation)), $.navigating.set(G.current = null);
}
...
function Xt() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    M && (M = false, history.replaceState({ ...history.state, [V]: ++v, [F]: R }, "", location.href));
  });
