...
let __tla = (async () => {
  ...
  const C = "" + new URL("../assets/kernel_bg.CYu-12--.wasm", import.meta.url).href, O = async (e = {}, t) => {
    let n;
  ...
  }, C), Y = f.memory, K = f.eval_input, P = f.__wbindgen_externrefs, V = f.__wbindgen_malloc, X = f.__wbindgen_realloc, $ = f.__wbindgen_free, p = f.__wbindgen_start, q = Object.freeze(Object.defineProperty({
    __proto__: null,
