...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && B.delete(Re(e)), wt(e, t));
...
const x = ((_a = globalThis.__sveltekit_1az9dqx) == null ? void 0 : _a.base) ?? "/toy-cas", Lt = ((_b = globalThis.__sveltekit_1az9dqx) == null ? void 0 : _b.assets) ?? x ?? "", At = "1772011160811", We = "sveltekit:snapshot", Fe = "sveltekit:scroll", Ge = "sveltekit:states", Ut = "sveltekit:pageurl", z = "sveltekit:history", F = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function Ye(e) {
...
const jt = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), C = Be(Fe) ?? {}, Y = Be(We) ?? {}, $ = { url: De({}), page: De({}), navigating: be(null), updated: Tt() };
function Ae(e) {
  C[e] = q();
}
function Nt(e, t) {
...
const Z = /* @__PURE__ */ new Map(), et = /* @__PURE__ */ new Set(), qt = /* @__PURE__ */ new Set(), W = /* @__PURE__ */ new Set();
let _ = { branch: [], error: null, url: null }, tt = false, oe = false, ze = true, J = false, M = false, nt = false, Te = false, at, v, R, N;
const se = /* @__PURE__ */ new Set(), Ke = /* @__PURE__ */ new Map();
async function ln(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_1az9dqx) == null ? void 0 : _a3.data) && globalThis.__sveltekit_1az9dqx.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = xt(e), I = document.documentElement, we = t, me = e.nodes[0], ne = e.nodes[1], me(), ne(), v = (_d2 = history.state) == null ? void 0 : _d2[z], R = (_e6 = history.state) == null ? void 0 : _e6[F], v || (v = R = Date.now(), history.replaceState({ ...history.state, [z]: v, [F]: R }, ""));
  const a = C[v];
  function r() {
    a && (history.scrollRestoration = "manual", scrollTo(a.x, a.y));
  }
  n ? (r(), await Qt(we, n)) : (await K({ type: "enter", url: Ye(y.hash ? tn(new URL(location.href)) : location.href), replace_state: true }), r()), Xt();
}
function Dt() {
...
function Me() {
  Ae(v), Ne(Fe, C), rt(R), Ne(We, Y);
}
async function Vt(e, t, n, a) {
  let r;
  t.invalidateAll && ve(), await K({ type: "goto", url: Ye(e), keepfocus: t.keepFocus, noscroll: t.noScroll, replace_state: t.replaceState, state: t.state, redirect_count: n, nav_token: a, accept: () => {
...
async function st(e, t, n) {
  ...
  if (a && a.remove(), Object.assign(k, e.props.page), at = new y.root({ target: t, props: { ...e.props, stores: $, components: re }, hydrate: n, sync: false }), await Promise.resolve(), ot(R), n) {
    const r = { from: null, to: { params: _.params, route: { id: ((_a3 = _.route) == null ? void 0 : _a3.id) ?? null }, url: new URL(location.href), scroll: C[v] ?? q() }, willUnload: false, type: "enter", complete: Promise.resolve() };
    W.forEach((i) => i(r));
  }
  oe = true;
}
...
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = _.url ? e !== ce(_.url) : false, h = _.route ? r.id !== _.route.id : false, w = Bt(_.url, n);
  let u = false;
...
async function K({ type: e, url: t, popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o = {}, redirect_count: s = 0, nav_token: c = {}, accept: l = Ve, block: f = Ve, event: h }) {
  ...
  if (Dt(), Ae(m), rt(g), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), o = n ? n.state : o, !n) {
    const b = i ? 0 : 1, Q = { [z]: v += b, [F]: R += b, [Ge]: o };
  ...
  !a && !ft && en(t, !P), ze = true, d.props.page && Object.assign(k, d.props.page), J = false, e === "popstate" && ot(R), p.fulfil(void 0), p.navigation.to && (p.navigation.to.scroll = q()), W.forEach((b) => b(p.navigation)), $.navigating.set(G.current = null);
}
...
function Xt() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    M && (M = false, history.replaceState({ ...history.state, [z]: ++v, [F]: R }, "", location.href));
  });
