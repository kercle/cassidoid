...
import { aW as be, aN as A, n as U, V as T, aM as ee, ba as dt } from "./CWZ4Cf0V.js";
import { o as Ce } from "./DFK7-NfU.js";
class ke {
  constructor(t, n) {
...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && W.delete(Re(e)), wt(e, t));
...
function vt(e, t) {
  ...
  if (a == null ? void 0 : a.textContent) {
    ...
    return o && W.set(n, { body: r, init: i, ttl: 1e3 * Number(o) }), a.getAttribute("data-b64") !== null && (r = mt(r)), Promise.resolve(new Response(r, i));
  }
  return window.fetch(e, t);
}
function yt(e, t, n) {
  if (W.size > 0) {
    const a = Re(e, n), r = W.get(a);
    if (r) {
  ...
  return { pattern: e === "/" ? /^\/$/ : new RegExp(`^${Et(e).map((a) => {
    ...
    return "/" + o.map((c, l) => {
      if (l % 2) {
        ...
        const f = bt.exec(c), [, h, w, u, p] = f;
        return t.push({ name: u, matcher: p, optional: !!h, rest: !!w, chained: w ? l === 1 && o[0] === "" : false }), w ? "([^]*?)" : h ? "([^/]*)?" : "([^/]+?)";
      }
      return he(c);
    }).join("");
  }).join("")}/?$`), params: t };
...
function Rt(e, t, n) {
  ...
  for (let s = 0; s < t.length; s += 1) {
    const c = t[s];
    let l = r[s - o];
    if (c.chained && c.rest && o && (l = r.slice(s - o, s + 1).filter((f) => f).join("/"), o = 0), l === void 0) if (c.rest) l = "";
    else continue;
...
function xt({ nodes: e, server_loads: t, dictionary: n, matchers: a }) {
  ...
  return Object.entries(n).map(([s, [c, l, f]]) => {
    ...
    }, errors: [1, ...f || []].map((p) => e[p]), layouts: [0, ...l || []].map(o), leaf: i(c) };
...
const x = ((_a = globalThis.__sveltekit_fjpwjj) == null ? void 0 : _a.base) ?? "/toy-cas", Lt = ((_b = globalThis.__sveltekit_fjpwjj) == null ? void 0 : _b.assets) ?? x ?? "", At = "1773144869680", Fe = "sveltekit:snapshot", Ge = "sveltekit:scroll", Ye = "sveltekit:states", Ut = "sveltekit:pageurl", K = "sveltekit:history", G = "sveltekit:navigation", C = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function ze(e) {
...
function _e(e, t, n) {
  ...
  const r = e instanceof SVGAElement ? e.target.baseVal : e.target, i = !a || !!r || le(a, t, n) || (e.getAttribute("rel") || "").split(/\s+/).includes("external"), o = (a == null ? void 0 : a.origin) === xe && e.hasAttribute("download");
...
function te(e) {
  ...
  return { preload_code: De[a ?? "off"], preload_data: De[r ?? "off"], keepfocus: c(t), noscroll: c(n), reload: c(i), replace_state: c(o) };
}
function qe(e) {
  const t = be(e);
  let n = true;
...
let k, Y, pe;
const Pt = Ce.toString().includes("$$") || /function \w+\(\) \{\}/.test(Ce.toString());
Pt ? (k = { data: {}, form: null, error: null, params: {}, route: { id: null }, state: {}, status: -1, url: new URL("https://example.com") }, Y = { current: null }, pe = { current: false }) : (k = new (_c = class {
  constructor() {
...
const Ct = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), $ = We(Ge) ?? {}, z = We(Fe) ?? {}, P = { url: qe({}), page: qe({}), navigating: be(null), updated: Tt() };
function Ae(e) {
  $[e] = D();
}
function Nt(e, t) {
...
const Z = /* @__PURE__ */ new Map(), et = /* @__PURE__ */ new Set(), Dt = /* @__PURE__ */ new Set(), F = /* @__PURE__ */ new Set();
let _ = { branch: [], error: null, url: null }, tt = false, oe = false, Ke = true, J = false, B = false, nt = false, Te = false, at, v, R, N;
const se = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map();
async function ln(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_fjpwjj) == null ? void 0 : _a3.data) && globalThis.__sveltekit_fjpwjj.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = xt(e), j = document.documentElement, we = t, me = e.nodes[0], ne = e.nodes[1], me(), ne(), v = (_d2 = history.state) == null ? void 0 : _d2[K], R = (_e6 = history.state) == null ? void 0 : _e6[G], v || (v = R = Date.now(), history.replaceState({ ...history.state, [K]: v, [G]: R }, ""));
  const a = $[v];
  function r() {
    a && (history.scrollRestoration = "manual", scrollTo(a.x, a.y));
  }
  n ? (r(), await Qt(we, n)) : (await M({ type: "enter", url: ze(y.hash ? tn(new URL(location.href)) : location.href), replace_state: true }), r()), Xt();
}
function qt() {
...
function Be() {
  Ae(v), Ne(Ge, $), rt(R), Ne(Fe, z);
}
async function Vt(e, t, n, a) {
  let r;
  t.invalidateAll && ve(), await M({ type: "goto", url: ze(e), keepfocus: t.keepFocus, noscroll: t.noScroll, replace_state: t.replaceState, state: t.state, redirect_count: n, nav_token: a, accept: () => {
    t.invalidateAll && (Te = true, r = [...Me.keys()]), t.invalidate && t.invalidate.forEach(Jt);
  } }), t.invalidateAll && ee().then(ee).then(() => {
    Me.forEach(({ resource: i }, o) => {
      var _a3;
...
async function st(e, t, n) {
  ...
  if (a && a.remove(), Object.assign(k, e.props.page), at = new y.root({ target: t, props: { ...e.props, stores: P, components: re }, hydrate: n, sync: false }), await Promise.resolve(), ot(R), n) {
    const r = { from: null, to: { params: _.params, route: { id: ((_a3 = _.route) == null ? void 0 : _a3.id) ?? null }, url: new URL(location.href), scroll: $[v] ?? D() }, willUnload: false, type: "enter", complete: Promise.resolve() };
    F.forEach((i) => i(r));
  }
  oe = true;
}
function ie({ url: e, params: t, branch: n, status: a, error: r, route: i, form: o }) {
  ...
  const c = { type: "loaded", state: { url: e, params: t, branch: n, error: r, route: i }, props: { constructors: It(n).map((u) => u.node.component), page: $e(k) } };
...
async function je({ loader: e, parent: t, url: n, params: a, route: r, server_data_node: i }) {
  var _a3, _b2;
  let o = null;
...
function Ft({ error: e, url: t, route: n, params: a }) {
  return { type: "loaded", state: { error: e, url: t, route: n, params: a, branch: [] }, props: { page: $e(k), constructors: [] } };
}
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = _.url ? e !== ce(_.url) : false, h = _.route ? r.id !== _.route.id : false, w = Wt(_.url, n);
  let u = false;
  const p = l.map(async (g, d) => {
    var _a3;
    if (!g) return;
    const S = _.branch[d];
    return g[1] === (S == null ? void 0 : S.loader) && !Bt(u, h, f, w, (_a3 = S.universal) == null ? void 0 : _a3.uses, a) ? S : (u = true, je({ loader: g[1], url: n, params: a, route: r, parent: async () => {
      var _a4;
      const I = {};
      for (let O = 0; O < d; O += 1) Object.assign(I, (_a4 = await p[O]) == null ? void 0 : _a4.data);
      return I;
    }, server_data_node: Ie(g[0] ? { type: "skip" } : null, g[0] ? S == null ? void 0 : S.server : void 0) }));
  });
  ...
  for (let g = 0; g < l.length; g += 1) if (l[g]) try {
    ...
    if (se.has(i)) return Ft({ error: await X(d, { params: a, url: n, route: { id: r.id } }), url: n, params: a, route: r });
    let S = Le(d), E;
    if (d instanceof ke) E = d.body;
    else {
      if (await P.updated.check()) return await Ze(), await H(n);
      E = await X(d, { params: a, url: n, route: { id: r.id } });
    }
    const I = await Gt(g, m, o);
    return I ? ie({ url: n, params: a, branch: m.slice(0, I.idx).concat(I.node), status: S, error: E, route: r }) : await lt(n, { id: r.id }, E, S);
  }
  else m.push(void 0);
...
async function Oe({ status: e, error: t, url: n, route: a }) {
  ...
  let i = null;
  try {
    const o = await je({ loader: me, url: n, params: r, route: a, parent: () => Promise.resolve({}), server_data_node: Ie(i) }), s = { node: await ne(), loader: ne, universal: null, server: null, data: null };
...
async function Yt(e) {
  ...
  try {
    const a = (async () => {
      let r = await y.hooks.reroute({ url: new URL(e), fetch: async (i, o) => Mt(i, o, e).promise }) ?? e;
      if (typeof r == "string") {
        const i = new URL(e);
...
async function ue(e, t) {
  if (e && !le(e, x, y.hash)) {
    ...
    for (const r of Ue) {
      const i = r.exec(a);
      if (i) return { id: ce(e), invalidating: t, route: r, params: gt(i), url: e };
    }
  }
}
function zt(e) {
...
function ct({ url: e, type: t, intent: n, delta: a, event: r, scroll: i }) {
  let o = false;
  const s = Pe(_, n, e, t, i ?? null);
  a !== void 0 && (s.navigation.delta = a), r !== void 0 && (s.navigation.event = r);
  const c = { ...s.navigation, cancel: () => {
    o = true, s.reject(new Error("navigation cancelled"));
  } };
  return J || et.forEach((l) => l(c)), o ? null : s;
}
async function M({ type: e, url: t, popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o = {}, redirect_count: s = 0, nav_token: c = {}, accept: l = Ve, block: f = Ve, event: h }) {
  var _a3;
  const w = N;
  N = c;
  const u = await ue(t, false), p = e === "enter" ? Pe(_, u, t, e) : ct({ url: t, type: e, delta: n == null ? void 0 : n.delta, intent: u, scroll: n == null ? void 0 : n.scroll, event: h });
  if (!p) {
    f(), N === c && (N = w);
    return;
  }
  const m = v, g = R;
  l(), J = true, oe && p.navigation.type !== "enter" && P.navigating.set(Y.current = p.navigation);
  let d = u && await it(u);
  if (!d) {
    if (le(t, x, y.hash)) return await H(t, i);
    d = await lt(t, { id: null }, await X(new Ee(404, "Not Found", `Not found: ${t.pathname}`), { url: t, params: {}, route: { id: null } }), 404, i);
  }
  if (t = (u == null ? void 0 : u.url) || t, N !== c) return p.reject(new Error("navigation aborted")), false;
  if (d.type === "redirect") {
    if (s < 20) {
      await M({ type: e, url: new URL(d.location, t), popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o, redirect_count: s + 1, nav_token: c }), p.fulfil(void 0);
      return;
    }
    d = await Oe({ status: 500, error: await X(new Error("Redirect loop"), { url: t, params: {}, route: { id: null } }), url: t, route: { id: null } });
  } else d.props.page.status >= 400 && await P.updated.check() && (await Ze(), await H(t, i));
  if (qt(), Ae(m), rt(g), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), o = n ? n.state : o, !n) {
    const b = i ? 0 : 1, Q = { [K]: v += b, [G]: R += b, [Ye]: o };
  ...
  if (oe) {
    ...
    const Q = S && await S;
    Q ? E = Q.commit() : (at.$set(d.props), $t(d.props.page), E = (_a3 = dt) == null ? void 0 : _a3()), nt = true;
  ...
  if (Ke) {
    ...
    b ? scrollTo(b.x, b.y) : (O = t.hash && document.getElementById(ut(t))) ? O.scrollIntoView() : scrollTo(0, 0);
  }
  const ft = document.activeElement !== I && document.activeElement !== document.body;
  !a && !ft && en(t, !O), Ke = true, d.props.page && Object.assign(k, d.props.page), J = false, e === "popstate" && ot(R), p.fulfil(void 0), p.navigation.to && (p.navigation.to.scroll = D()), F.forEach((b) => b(p.navigation)), P.navigating.set(Y.current = null);
}
async function lt(e, t, n, a, r) {
  return e.origin === xe && e.pathname === location.pathname && !tt ? await Oe({ status: a, error: n, url: e, route: t }) : await H(e, r);
}
function Ht() {
  ...
  j.addEventListener("mousedown", a), j.addEventListener("touchstart", a, { passive: true });
  const r = new IntersectionObserver((s) => {
    for (const c of s) c.isIntersecting && (ge(new URL(c.target.href)), r.unobserve(c.target));
  }, { threshold: 0 });
  async function i(s, c) {
    const l = Je(s, j), f = l === t.element && (l == null ? void 0 : l.href) === t.href && c >= n;
    if (!l || f) return;
    const { url: h, external: w, download: u } = _e(l, x, y.hash);
    if (w || u) return;
    const p = te(l), m = h && ce(_.url) === ce(h);
    if (!(p.reload || m)) if (c <= p.preload_data) {
      t = { element: l, href: l.href }, n = C.tap;
      const g = await ue(h, false);
      if (!g) return;
      Kt(g);
    } else c <= p.preload_code && (t = { element: l, href: l.href }, n = c, ge(h));
  }
  function o() {
    r.disconnect();
    for (const s of j.querySelectorAll("a")) {
      const { url: c, external: l, download: f } = _e(s, x, y.hash);
      if (l || f) continue;
      const h = te(s);
      h.reload || (h.preload_code === C.viewport && r.observe(s), h.preload_code === C.eager && ge(c));
    }
  }
  F.add(o), o();
}
...
function Xt() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    let n = false;
    if (Be(), !J) {
      const a = Pe(_, void 0, null, "leave"), r = { ...a.navigation, cancel: () => {
  ...
  }), ((_a3 = navigator.connection) == null ? void 0 : _a3.saveData) || Ht(), j.addEventListener("click", async (t) => {
    if (t.button || t.which !== 1 || t.metaKey || t.ctrlKey || t.shiftKey || t.altKey || t.defaultPrevented) return;
    const n = Je(t.composedPath()[0], j);
    if (!n) return;
    ...
    const [l, f] = (y.hash ? a.hash.replace(/^#/, "") : a.href).split("#"), h = l === de(location);
    if (r || s.reload && (!h || !f)) {
      ct({ url: a, type: "link", event: t }) ? J = true : t.preventDefault();
      return;
    }
    if (f !== void 0 && h) {
      ...
      if (B = true, Ae(v), e(a), !s.replace_state) return;
      B = false;
    }
    ...
    if (!ye) {
      if ((_a4 = t.state) == null ? void 0 : _a4[K]) {
        const n = t.state[K];
        if (N = {}, n === v) return;
        const a = $[n], r = t.state[Ye] ?? {}, i = new URL(t.state[Ut] ?? location.href), o = t.state[G], s = _.url ? de(location) === de(_.url) : false;
        if (o === R && (nt || s)) {
          r !== k.state && (k.state = r), e(i), $[v] = D(), a && scrollTo(a.x, a.y), v = n;
          return;
        }
        const l = n - v;
    ...
    B && (B = false, history.replaceState({ ...history.state, [K]: ++v, [G]: R }, "", location.href));
  });
  for (const t of document.querySelectorAll("link")) Ct.has(t.rel) && (t.href = t.href);
  addEventListener("pageshow", (t) => {
    t.persisted && P.navigating.set(Y.current = null);
  });
  function e(t) {
    _.url = k.url = t, P.page.set($e(k)), P.page.notify();
  }
}
async function Qt(e, { status: t = 200, error: n, node_ids: a, params: r, route: i, server_route: o, data: s, form: c }) {
  tt = true;
  const l = new URL(location.href);
  let f;
  ({ params: r = {}, route: i = { id: null } } = await ue(l, false) || {}), f = Ue.find(({ id: u }) => u === i.id);
  let h, w = true;
  try {
    const u = a.map(async (m, g) => {
      const d = s[g];
      return (d == null ? void 0 : d.uses) && (d.uses = Zt(d.uses)), je({ loader: y.nodes[m], url: l, params: r, route: i, parent: async () => {
        const S = {};
        for (let E = 0; E < g; E += 1) Object.assign(S, (await u[E]).data);
        return S;
      }, server_data_node: Ie(d) });
    }), p = await Promise.all(u);
    if (f) {
      const m = f.layouts;
      for (let g = 0; g < m.length; g++) m[g] || p.splice(g, 0, void 0);
    }
    h = ie({ url: l, params: r, branch: p, status: t, error: n, form: c, route: f ?? null });
  } catch (u) {
    if (u instanceof Se) {
      await H(new URL(u.location, location.href));
      return;
    }
    h = await Oe({ status: Le(u), error: await X(u, { url: l, params: r, route: i }), url: l, route: i }), e.textContent = "", w = false;
  }
